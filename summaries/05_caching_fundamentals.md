...
- _Note:_ TTL controls staleness; Eviction controls memory capacity.
...
3. **Probabilistic Early Expiration (XFetch):** Randomly refresh a key _before_ it expires to spread load.
